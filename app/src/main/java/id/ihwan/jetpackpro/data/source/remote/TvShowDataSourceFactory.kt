...
class TvShowDataSourceFactory(private val service: TMDBApiService) : DataSource.Factory<Int, ResultsData>() {

    val dataSourceLiveData = MutableLiveData<TvShowDataSource>()
